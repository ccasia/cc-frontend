...
export default function CreatorSendDrafts() {
  ...
  const validSubmissions = submissions.filter(
    (submission) =>
      (submission.type === "FIRST_DRAFT" || submission.type === "FINAL_DRAFT") &&
            ...
            <Table>
              ...
              <TableBody>
                {validSubmissions.map((submission) => {
                  ...
                  const startDate = dayjs(submission.nextsubmission);
                  const diffInSeconds = submissionDate.diff(startDate, "second");

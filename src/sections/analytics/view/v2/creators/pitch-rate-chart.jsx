...
import { MOCK_PITCH_RATE } from '../mock-data';
...
export default function PitchRateChart() {
  const filtered = useFilteredData(MOCK_PITCH_RATE);
  ...
  return (
    <ChartCard title="Pitch Rate" icon={TrackChangesIcon} subtitle="Creators who pitched / total active creators" headerRight={headerRight}>

...
export default function BrandItem({ job, onView, onEdit, onDelete }) {
  const popover = usePopover();

  const { title, company, createdAt, candidates, experience, employmentTypes, salary, role } = job;
      ...
      <Card>
        ...
        <Stack sx={{ p: 3, pb: 2 }}>
          ...
          <ListItemText
            ...
            secondary={`Posted date: ${fData(createdAt)}`}

...
const CampaignModal = ({ open, handleClose, campaign, openForm, dialog }) => {
  ...
  const hasPitched = !!existingPitch;
  const isPitchApproved = existingPitch?.status === 'approved';
          ...
          <Box sx={{ px: 3, pb: 3, }}>
            ...
            >
              ...
              >
                <Button
                  variant="contained"
                  onClick={hasPitched ? () => handleManageClick(campaign.id) : handlePitch}
                  sx={{
                ...
                >
                  {hasPitched ? 'Manage' : 'Pitch Yourself'}
                </Button>
                <Button
                  variant="outlined"

...
export const endpoints = {
  ...
  analytics: {
    ...
    timeToIgActivation: '/api/analytics/v2/time-to-ig-activation',
    timeToIgActivationCreators: '/api/analytics/v2/time-to-ig-activation/creators',
    timeToTiktokActivation: '/api/analytics/v2/time-to-tiktok-activation',
    timeToTiktokActivationCreators: '/api/analytics/v2/time-to-tiktok-activation/creators',
    ...
    tracker: '/api/analytics/v2/tracker',
    client: {
      brands: '/api/analytics/v2/client/brands',
      campaigns: '/api/analytics/v2/client/campaigns',
      approve: '/api/analytics/v2/client/approve',
      journey: '/api/analytics/v2/client/journey',
      support: '/api/analytics/v2/client/support',
      shortlist: '/api/analytics/v2/client/shortlist',
    },
  },
  overview: {

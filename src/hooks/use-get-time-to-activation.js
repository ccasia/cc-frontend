...
const useGetTimeToActivation = ({ granularity, startDate, endDate, creditTiers = [] } = {}) => {
  const url = useMemo(() => {
    const base = endpoints.analytics.timeToActivation;
...
export default useGetTimeToActivation;
